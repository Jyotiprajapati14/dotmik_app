...
Color primary = const Color(0xff5d34a6);
class Styles{
  ...
  static TextStyle headLineStyle3 = TextStyle(fontSize:19,fontWeight: FontWeight.w500 ,);
  static TextStyle headLineStyle4 = TextStyle(fontSize:15,color: Colors.grey.shade500,fontWeight: FontWeight.w500 ,);
