...
class GasBillsFormScreen extends StatefulWidget {
  @override
  _FormScreenState createState() => _FormScreenState();
}

class _FormScreenState extends State<GasBillsFormScreen> {
  String bankAccount = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(titleText: 'Gas Bill',),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            _buildBankDropdown("Select Bill Category"),
            ...
            CustomImageButton(
              ...
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => GasBillDetailScreen()));
              },
              color: Colors.red,
            ),
          ],
...
class GasBillDetailScreen extends StatefulWidget {
  @override
  _BillDetailsScreenState createState() => _BillDetailsScreenState();
}

class _BillDetailsScreenState extends State<GasBillDetailScreen> {
  DateTime selectedDate = DateTime.now();
