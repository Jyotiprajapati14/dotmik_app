...
class LoanBillsFormScreen extends StatefulWidget {
  @override
  _FormScreenState createState() => _FormScreenState();
}

class _FormScreenState extends State<LoanBillsFormScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(titleText: 'Loan Bill',),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            _buildBankDropdown("Select Biller"),
            ...
            _buildTextField(
              ...
              maxLength: 10, hintText: 'Enter Mobile Number'
            ),
            SizedBox(height: 20.0),
            CustomImageButton(
              text: 'Fetch Bill',
              ...
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => ElectricityFullFormScreen()));
              },
              color: Colors.red,
            ),
          ],
...
class ElectricityFullFormScreen extends StatefulWidget {
  @override
  _FullFormDetailsScreenState createState() => _FullFormDetailsScreenState();
}

class _FullFormDetailsScreenState extends State<ElectricityFullFormScreen> {
  String bankAccount = '';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 20.0),
            _buildBankDropdown("Select Bill Catergory"),
            SizedBox(height: 10.0),
            _buildTextField(
              label: 'Mobile Number',
            ...
            CustomImageButton(
              ...
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => ElectricityBillDetailScreen()));
              },
              color: Colors.red,
            ),
          ],
...
class ElectricityBillDetailScreen extends StatefulWidget {
  @override
  _BillDetailsScreenState createState() => _BillDetailsScreenState();
}

class _BillDetailsScreenState extends State<ElectricityBillDetailScreen> {
  DateTime selectedDate = DateTime.now();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(titleText: 'Electricity Bill',),
      body: Padding(
