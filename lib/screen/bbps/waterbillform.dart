...
class WaterBillsFormScreen extends StatefulWidget {
  @override
  _FormScreenState createState() => _FormScreenState();
}

class _FormScreenState extends State<WaterBillsFormScreen> {
  String bankAccount = '';
            ...
            CustomImageButton(
              ...
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => WaterBillDetailScreen()));
              },
              color: Colors.red,
            ),
          ],
...
class WaterBillDetailScreen extends StatefulWidget {
  @override
  _BillDetailsScreenState createState() => _BillDetailsScreenState();
}

class _BillDetailsScreenState extends State<WaterBillDetailScreen> {
  DateTime selectedDate = DateTime.now();
