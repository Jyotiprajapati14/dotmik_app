...
class RegisterBankFormScreen extends StatefulWidget {
  @override
  _RegisterUPIFormScreenState createState() => _RegisterUPIFormScreenState();
}

class _RegisterUPIFormScreenState extends State<RegisterBankFormScreen> {
  String bankAccount = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(titleText: 'Register Bank',),
