...
class CreditCardBillsFormScreen extends StatefulWidget {
  @override
  _FullFormDetailsScreenState createState() => _FullFormDetailsScreenState();
}

class _FullFormDetailsScreenState extends State<CreditCardBillsFormScreen> {
  String bankAccount = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(titleText: 'Credit Card',),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            _buildBankDropdown("Credit Card Number"),
            SizedBox(height: 10.0),
            _buildBankDropdown("Card Type"),
            SizedBox(height: 10.0),
            _buildTextField(
              label: 'Mobile No.',
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              BillDetailRow(label: 'Per Transaction Limit', value: '545545'),
              SizedBox(height: 10),
              BillDetailRow(
